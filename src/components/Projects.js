...
export default function Projects(){
    ...
    const config = {
        projects: [
            {
                image: websiteImg1,
                description: 'A Blog page which tells about the Honor of the game...',
                link: 'https://methegoku.github.io/TESP---The-Elder-Scrolls-Page/'
            },

            {
                image: websiteImg2,
                description: 'A Weather App which Tells how the weather in is the country',
                link: 'https://github.com/methegoku/Weather-App'
            },

            {
                image: websiteImg3,
                description: 'A Responsive Website which is built with reactJS and tailwind CSS - which u are seeing now!',
                link: 'https://github.com/methegoku/Portfolio-Website'
            }
        ]
    }
